...
public class Main {
	...
	public static void main(String[] args)
	{
		...
		//String text = "List the name, surname, id and course code from scholar who take course from ?zkan K?l??.";
	    ...
	    //String text = "List the students who takes course from ?zkan K?l??.";
